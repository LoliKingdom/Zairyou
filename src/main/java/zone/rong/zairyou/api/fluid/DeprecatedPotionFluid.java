...
@Deprecated
public class DeprecatedPotionFluid extends Fluid {

    private final Materials.DeprecatedPotions.PotionFormat potionFormat;
    private final PotionType potionType;

    public DeprecatedPotionFluid(Material material, Materials.DeprecatedPotions.PotionFormat potionFormat, PotionType potionType) {
        super(material.getName(), new ResourceLocation(Zairyou.ID, "blocks/fluids/potion_still"), new ResourceLocation(Zairyou.ID, "blocks/fluids/potion_flow"));
    ...
    public Materials.DeprecatedPotions.PotionFormat getPotionFormat() {
        return potionFormat;
    }
