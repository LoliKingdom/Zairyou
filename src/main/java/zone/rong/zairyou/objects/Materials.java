...
public class Materials {
    ...
    public static final Material RICH = of("rich", 0x0).types(FERTILIZER, SLAG).noTints(FERTILIZER, SLAG).texture(FERTILIZER, "custom/rich_fertilizer").texture(SLAG, "custom/rich_slag");

    public static final Material FLUX = of("flux", 0x0).type(FERTILIZER).noTint(FERTILIZER).texture(FERTILIZER, "custom/flux_fertilizer");
